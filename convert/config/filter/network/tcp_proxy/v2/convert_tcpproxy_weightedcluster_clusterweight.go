...
func Convert_TcpProxy_WeightedCluster_ClusterWeight(conf *config.ConfigCtx, c *envoy_config_filter_network_tcp_proxy_v2.TcpProxy_WeightedCluster_ClusterWeight) (string, error) {
	logger.Todof("%#v", c)
	return "", nil
}
