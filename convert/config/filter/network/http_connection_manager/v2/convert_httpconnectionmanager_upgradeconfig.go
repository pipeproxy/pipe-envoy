...
func Convert_HttpConnectionManager_UpgradeConfig(conf *config.ConfigCtx, c *envoy_config_filter_network_http_connection_manager_v2.HttpConnectionManager_UpgradeConfig) (string, error) {
	logger.Todof("%#v", c)
	return "", nil
}
