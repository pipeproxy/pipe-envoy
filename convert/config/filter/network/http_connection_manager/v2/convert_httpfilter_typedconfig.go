...
func Convert_HttpFilter_TypedConfig(conf *config.ConfigCtx, c *envoy_config_filter_network_http_connection_manager_v2.HttpFilter_TypedConfig) (string, error) {
	logger.Todof("%#v", c)
	return "", nil
}
