...
func Convert_ScopedRoutes_ScopeKeyBuilder_FragmentBuilder(conf *config.ConfigCtx, c *envoy_config_filter_network_http_connection_manager_v2.ScopedRoutes_ScopeKeyBuilder_FragmentBuilder) (string, error) {
	logger.Todof("%#v", c)
	return "", nil
}
