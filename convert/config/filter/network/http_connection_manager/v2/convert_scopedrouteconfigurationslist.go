...
func Convert_ScopedRouteConfigurationsList(conf *config.ConfigCtx, c *envoy_config_filter_network_http_connection_manager_v2.ScopedRouteConfigurationsList) (string, error) {
	logger.Todof("%#v", c)
	return "", nil
}
